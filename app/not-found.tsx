      ...
      <div className="container relative z-10 flex flex-col items-center text-center px-4">
        ...
        <div className="max-w-md space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              asChild
              size="lg"
              className="w-full sm    :w-auto rounded-full px-8 shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all duration-300"
            >
            </Button>
        ...
        <div className="mt-16 pt-8 border-t border-border/50 w-full max-w-xs">
          <p className="text-sm text-muted-foreground">
            Butuh bantuan?{' '}
            <Link href="/kontak" className="text-primary hover:underline font-semibold decoration-2 underline-offset-4">
              Hubungi Admin
            </Link>
          </p>
        </div>
