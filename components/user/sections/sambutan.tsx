                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                        ...
                        <div className="relative w-full lg:w-[38%] max-w-[320px] lg:max-w-none mx-auto">
                            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-lg border-4 border-white bg-white">
                                <Image
                                    src="/userPlaceholder.jpg"
                                    alt="drg. Karina Amalia"
                                    fill
                            ...
                            {/* Motto Card - More Compact */}
                            <div className="mt-4 lg:absolute lg:-bottom-6 lg:-right-8 bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-md border border-slate-100 max-w-[200px]">
                        ...
                        <div className="w-full lg:w-[62%] space-y-5">
                            <div className="space-y-3">
                                ...
                                <h2 className="text-2xl md:text-4xl font-bold tracking-tight text-slate-900 leading-tight">
                                    ...
                                    <span className="text-blue-600">UPTD Puskesmas Bogor Tengah</span>
                                </h2>
                            </div>
                            ...
                            <div className="space-y-4 text-slate-600 text-sm md:text-base leading-relaxed">
                                ...
                                <p>
                                    ...
                                    <span className="font-semibold text-slate-900"> UPTD Puskesmas Bogor Tengah </span>
                            ...
                            <div className="pt-5 border-t border-slate-100">
                                <h4 className="text-lg font-bold text-slate-900">drg. Karina Amalia</h4>
